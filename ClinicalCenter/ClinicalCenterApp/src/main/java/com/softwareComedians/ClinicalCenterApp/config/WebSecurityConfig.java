...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers("**/api/**").permitAll()
            .antMatchers("/HomepagePatient/**").hasRole("PATIENT")
            .antMatchers("**/HomepagePatient/**").hasRole("PATIENT")
            .antMatchers("/HomepageCA/**").hasRole("CA")
            .antMatchers("**/HomepageCA/**").hasRole("CA")
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.GET, "/api/patient/getAll");
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/api/diagnosis");
        web.ignoring().antMatchers(HttpMethod.GET, "/api/diagnosis/getAll");
        web.ignoring().antMatchers(HttpMethod.DELETE, "/api/diagnosis/del/{id}");
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/api/ConsultTerm/reserve/{idr}/{s}/{id}");
