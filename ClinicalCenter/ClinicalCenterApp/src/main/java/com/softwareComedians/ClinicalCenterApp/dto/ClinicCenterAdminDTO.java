...
public class ClinicCenterAdminDTO extends UserDTO {
    ...
    public ClinicCenterAdminDTO(Long id, String name, String surname, String ucidn, String address, String city, String country, String email, String phone, String username, String password, String role, boolean isActivated) {
